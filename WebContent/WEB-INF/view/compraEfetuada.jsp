                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${pedido.itensDoPedido}" var="produto">
                                            <tr>
                                                ...
                                                <td>${produto.nome}</td>
                                                <td>
                                                    <fmt:formatNumber value="${produto.valor}" type="currency" maxFractionDigits="2"></fmt:formatNumber>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        <tr>
                                            ...
                                            <td>
                                                <fmt:formatNumber value="${pedido.valorTotal}" type="currency" maxFractionDigits="2"></fmt:formatNumber>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
